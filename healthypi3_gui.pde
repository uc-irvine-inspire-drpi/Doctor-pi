// This is the code with the color edits.
//////////////////////////////////////////////////////////////////////////////////////////
//
...
String default_mqtt_username = "slakhany";
String default_mqtt_password = "6de9fe221efc443a93870c4acc5393a1";
...
// NOTE** see what these variables are used for, maybe you can use it later
...
public void setup() 
{
  ...
  //plotECG.setBgColor(color(0,0,0));
  //plotECG.setBgColor(color(0,0,0));
  //plotECG.setBgColor(255);
  //plotECG.setBoxBgColor(255);
  // maybe take this out
  //plotECG.setLineColor(color(0, 255, 0));
  plotECG.setLineColor(color(5, 167, 214));
  ...
  plotPPG.setBoxBgColor(255);
  plotPPG.setLineColor(color(237, 182, 89));
  ...
  plotResp.setBoxBgColor(255);
  plotResp.setLineColor(color(11, 157, 95));
...
void setupMQTT() 
{
    ...
    // I added this
    String phoneNumber = cp5.get(Textfield.class, "Enter your phone number: ").getText();
...
//--------------------------------------------------------------------------------------     
        ...
        public void controlEvent(CallbackEvent event) {
          if (event.getAction() == ControlP5.ACTION_RELEASED) 
          {
            ...
            { 
              ...
              Runtime.getRuntime().exec("python3 /home/pi/main.py");
              ////String command = "/home/pi/main.py"; 
              //String[] cmd = {
              //          "/bin/bash",
              //           "-c",
  ...
  */               
  ...
  {     
      ...
      .setColorValue(color(237, 182, 89))
      .setFont(createFont("Impact",40));
